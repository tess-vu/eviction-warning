...
```{r model-1}
library(glmmTMB)
# Fit baseline Negative Binomial model with core time, policy, and monthly predictors. I used glmmTMB because my model kept crashing this is good for big datasets, zero-heavy count distribution. I also changed the beginning of the rest of the code
model_nb_1 <- glmmTMB(
